...
ENV \
    ...
    G4ABLADATA="/opt/geant4/share/Geant4-10.3.2/data/G4ABLA3.0" \
    G4ENSDFSTATEDATA="/opt/geant4/share/Geant4-10.3.2/data/G4ENSDFSTATE2.1" \
    G4LEDATA="/opt/geant4/share/Geant4-10.3.2/data/G4EMLOW6.50" \
    G4LEVELGAMMADATA="/opt/geant4/share/Geant4-10.3.2/data/PhotonEvaporation4.3" \
    G4NEUTRONHPDATA="/opt/geant4/share/Geant4-10.3.2/data/G4NDL4.5" \
    G4NEUTRONXSDATA="/opt/geant4/share/Geant4-10.3.2/data/G4NEUTRONXS1.4" \
...
RUN true \
    ...
    && provisioning/install-sw.sh geant4 10.3.2 /opt/geant4
...
RUN true \
    && yum install -y \
        openblas-devel \
        opencv-devel \
    && provisioning/install-sw.sh mxnet dmlc/v0.10.0 /opt/mxnet
